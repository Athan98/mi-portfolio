...
public class CancelarCtaCte extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jlFDP.setText("Ingrese el monto a cancelar");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(CancelarCtaCte.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new CancelarCtaCte().setVisible(true);
            }
        });
    }
