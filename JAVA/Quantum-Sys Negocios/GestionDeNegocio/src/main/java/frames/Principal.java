...
//        ejectuarXAMPP();
    ...
    private void initComponents() {
        ...
        jbProductos.setBackground(new java.awt.Color(63, 34, 66));
        ...
        jbVentas.setBackground(new java.awt.Color(63, 34, 66));
        ...
        jbProveedores.setBackground(new java.awt.Color(63, 34, 66));
        ...
        jbPedidos.setBackground(new java.awt.Color(63, 34, 66));
        ...
        jbEstadisticas.setBackground(new java.awt.Color(63, 34, 66));
        ...
        jbConsultas.setBackground(new java.awt.Color(63, 34, 66));
        ...
        jbCaja.setBackground(new java.awt.Color(63, 34, 66));
        ...
        jbSistema.setBackground(new java.awt.Color(63, 34, 66));
