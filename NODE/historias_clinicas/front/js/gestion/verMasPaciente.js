document.addEventListener("DOMContentLoaded", () => {
        ...
        try {
            ...
            estudiosPaciente.forEach(e => {
                ...
                btnMas.addEventListener("click", () => {
                    window.location.href = `/historias_clinicas/front/pages/gestion/verMasEstudio.html?id=${e.id}`
                });
    ...
    const agregarEstudioAContainer = (e, contenedor, idPaciente) => {
        ...
        btnMas.classList.add("btnMas");
        btnMas.addEventListener("click", () => {
            window.location.href = `/historias_clinicas/front/pages/gestion/verMasEstudio.html?id=${e.id}`; // Navega a los detalles del estudio
        });
    ...
    const editarPaciente = () => {
        if (idPaciente) {
            window.location.href = `/historias_clinicas/front/pages/gestion/editarPaciente.html?id=${idPaciente}`;
        }
    };

    const agregarEstudio = () => {
        if (idPaciente) {
            window.location.href = `/historias_clinicas/front/pages/gestion/nuevoEstudio.html?id=${idPaciente}`;
        }
    };
