...
public class FormasDePagoPedidos_data implements Repository<FormasDePagoPedidos> {
    ...
    public void agregar(FormasDePagoPedidos t) {
        ...
        session.save(t);
        JOptionPane.showMessageDialog(null, "La FDPP ha sido agregada a la base de datos");
        trans.commit();
    }
    ...
    public void actualizar(FormasDePagoPedidos t) {
        Transaction trans = session.beginTransaction();
        session.update(t);
        JOptionPane.showMessageDialog(null, "LA FDPP ha sido actualizada");
        trans.commit();
    }
    ...
    public void eliminar(FormasDePagoPedidos t) {
        Transaction trans = session.beginTransaction();
        session.delete(t);
        JOptionPane.showMessageDialog(null, "La FDPP ha sido eliminada");
        trans.commit();
    }
